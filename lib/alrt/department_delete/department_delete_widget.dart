...
import 'department_delete_model.dart';
export 'department_delete_model.dart';

class DepartmentDeleteWidget extends StatefulWidget {
  const DepartmentDeleteWidget({
    super.key,
  ...
  @override
  State<DepartmentDeleteWidget> createState() => _DepartmentDeleteWidgetState();
}

class _DepartmentDeleteWidgetState extends State<DepartmentDeleteWidget> {
  late DepartmentDeleteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DepartmentDeleteModel());
