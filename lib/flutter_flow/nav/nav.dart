...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: ContactUsFormWidget.routeName,
          path: ContactUsFormWidget.routePath,
          builder: (context, params) => ContactUsFormWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: LoginVerificationWidget.routePath,
        ...
        FFRoute(
          ...
          builder: (context, params) => AdminMyTeamWidget(),
        ),
        FFRoute(
          name: AdminBranchWidget.routeName,
          path: AdminBranchWidget.routePath,
          builder: (context, params) => AdminBranchWidget(),
        ),
        FFRoute(
          name: AdminDepartmentWidget.routeName,
          path: AdminDepartmentWidget.routePath,
          builder: (context, params) => AdminDepartmentWidget(),
        ),
        FFRoute(
          name: AdminDesignationWidget.routeName,
          path: AdminDesignationWidget.routePath,
          builder: (context, params) => AdminDesignationWidget(),
        ),
        FFRoute(
          name: AdminCompaniesWidget.routeName,
          path: AdminCompaniesWidget.routePath,
          builder: (context, params) => AdminCompaniesWidget(),
        ),
        FFRoute(
