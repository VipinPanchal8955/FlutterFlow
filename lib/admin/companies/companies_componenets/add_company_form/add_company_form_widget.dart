...
import 'add_company_form_model.dart';
export 'add_company_form_model.dart';

class AddCompanyFormWidget extends StatefulWidget {
  const AddCompanyFormWidget({
    super.key,
    this.companyList,
  });

  final Future Function()? companyList;

  @override
  State<AddCompanyFormWidget> createState() => _AddCompanyFormWidgetState();
}

class _AddCompanyFormWidgetState extends State<AddCompanyFormWidget> {
  late AddCompanyFormModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddCompanyFormModel());
    ...
    _model.gTSCodeTextController ??= TextEditingController();
    _model.gTSCodeFocusNode ??= FocusNode();
                          ...
                          children: [
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 4.0, 0.0, 0.0),
                              child: Text(
                                'Please enter company details below to create their profile.',
                                style: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                                      fontFamily: 'Anwatrix_Font',
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Container(
                          width: 370.0,
                          child: TextFormField(
                            controller: _model.gTSCodeTextController,
                            focusNode: _model.gTSCodeFocusNode,
                            onChanged: (_) => EasyDebounce.debounce(
                              '_model.gTSCodeTextController',
                              Duration(milliseconds: 100),
                              () => safeSetState(() {}),
                            ),
                            autofocus: true,
                            ...
                            cursorColor:
                                FlutterFlowTheme.of(context).primaryText,
                            validator: _model.gTSCodeTextControllerValidator
                                .asValidator(context),
                            inputFormatters: [
                              if (!isAndroid && !isiOS)
                                TextInputFormatter.withFunction(
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  _shouldSetState = true;
                                  _model.queriedCompanies =
                                      await queryCompaniesRecordOnce(
                                    singleRecord: true,
                                  ).then((s) => s.firstOrNull);
                                  _shouldSetState = true;
                                  if (_model.queriedCompanies?.gstNumber ==
                                      _model.gTSCodeTextController.text) {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          'This GSTIN is already registered. Please check and try again.',
                                          style: FlutterFlowTheme.of(context)
                                              .titleSmall
                                              .override(
                                                fontFamily: 'Anwatrix_Font',
                                    ...
                                    await _model.createCompany!.reference
                                        .update(createCompaniesRecordData(
                                      companyDoc:
                                          _model.createCompany?.reference,
                                    ));
                                    await widget.companyList?.call();
                                    safeSetState(() {
                                      _model.companyNameTextController?.clear();
                                      _model.gTSCodeTextController?.clear();
                                      _model.companyAddressTextController
                                          ?.clear();
                                    });
                                    safeSetState(() {
                                      _model.statusValueController?.reset();
                                      _model.cityNameValueController?.reset();
                                      _model.stateNameValueController?.reset();
                                      _model.countryNameValueController
                                          ?.reset();
                                    });
                                    Navigator.pop(context);
                                    ScaffoldMessenger.of(context).showSnackBar(
