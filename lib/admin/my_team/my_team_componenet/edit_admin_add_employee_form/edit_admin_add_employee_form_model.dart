...
import 'edit_admin_add_employee_form_widget.dart'
    show EditAdminAddEmployeeFormWidget;
import 'package:flutter/material.dart';

class EditAdminAddEmployeeFormModel
    extends FlutterFlowModel<EditAdminAddEmployeeFormWidget> {
  ///  Local state fields for this component.

  CompaniesRecord? selectedCompnay;
  ...
  // Stores action output result for [Backend Call - Read Document] action in Edit_Admin_Add_Employee_form widget.
  UsersRecord? adminEditEmployeeForm;
  // Stores action output result for [Firestore Query - Query a collection] action in Edit_Admin_Add_Employee_form widget.
  CompaniesRecord? userCompany;
  // State field(s) for Employee_Company widget.
  String? employeeCompanyValue;
  FormFieldController<String>? employeeCompanyValueController;
  // Stores action output result for [Firestore Query - Query a collection] action in Employee_Company widget.
  CompaniesRecord? selectedCompany;
  // Stores action output result for [Firestore Query - Query a collection] action in Employee_Company widget.
  List<CompaniesBranchesRecord>? branchQuery;
  // Stores action output result for [Firestore Query - Query a collection] action in Employee_Company widget.
  List<CompaniesDepartmentsRecord>? departmentQuery;
  // Stores action output result for [Firestore Query - Query a collection] action in Employee_Company widget.
  List<CompaniesDesignationsRecord>? designationQuery;
