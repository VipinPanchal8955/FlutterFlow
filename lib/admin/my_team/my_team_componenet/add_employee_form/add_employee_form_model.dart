...
import 'add_employee_form_widget.dart' show AddEmployeeFormWidget;
import 'package:flutter/material.dart';

class AddEmployeeFormModel extends FlutterFlowModel<AddEmployeeFormWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in Add_Employee_form widget.
  ...
  UsersRecord? userCollectionOwner;
  // Stores action output result for [Backend Call - Create Document] action in Button widget.
  UsersRecord? userCreateByOwner;
